> **This is the developer / reference document.** It is the former root README.md,
> moved into docs/ on 2026-09-24 when the repository front page was rewritten.
> For a user-facing intro, downloads and the quick start, go back to
...
logs/            per-run self-test / regression logs and screenshots (evidence;
                 **not in git** — the ones the README uses are copied to images/)
